...
const CheckoutForm = ({ onClose, total, onPaymentSuccess }: Omit<Props, 'isOpen'>) => {
              ...
              <div className="mb-6">
                    ...
                    <div className="mb-4 text-red-600 text-sm bg-red-50 p-3 rounded-lg flex items-center gap-2">
                        <span>
                         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            ...
                            <path fill="none" stroke="currentColor" stroke-width="1.8" d="M12 3L2.5 20h19L12 3z"/>
                ...
                <button 
                    ...
                    {loading ? (
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <title>Pagar (tarjeta)</title> {/**debería parecer esto al posar el mouse encima del icono */}
                        <path fill="currentColor" d="M3 4h18a2 2 0 0 1 2 2v3H1V6a2 2 0 0 1 2-2zm-2 7h22v7a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-7zm5 4h4v2H6v-2z"/>
                        </svg>
                        </>
                    )}
                </button>
                <div className="mt-4 text-center text-xs text-gray-400 flex items-center justify-center gap-1">
                    {/**Svg de un candado*/}
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="currentColor" d="M17 8h-1V6a4 4 0 0 0-8 0v2H7a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2zm-3 0H10V6a2 2 0 0 1 4 0v2z"/>
                        </svg>
...
//El Modal
export const PasarelaStripe = ({isOpen, onClose, total, onPaymentSuccess }: Props) => {
